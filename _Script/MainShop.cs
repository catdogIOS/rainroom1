...
public class MainShop : MonoBehaviour
{
    ...
    //외출
    public GameObject clock_obj, draw_obj, frame_obj, fish_obj, glassBtn_obj;
    public Text txt;
        ...
        else
        {
            ...
            if (have_r >= cost_r)
            {
                if (have_h >= cost_h)
                {
                    ...
                    glassBtn_obj.GetComponent<Image>().sprite = spr_glass[0];
                }
                else
                {
                    shopPopup_obj.SetActive(true);
    ...
    void NoticeOne()
    {
        if (PlayerPrefs.GetInt("notice2",0)==0)
        {
